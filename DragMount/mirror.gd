...
func _ready() -> void:
	...
	mount.set_collision_layer_value(2, true)
	mount.set_collision_mask_value(1, false)
	mount.set_collision_mask_value(2, true)
	mount.input_event.connect(_mount_input_event)

	fixture.input_pickable = true
	fixture.add_collision_exception_with(mount)
	fixture.set_collision_layer_value(1, true)
	fixture.set_collision_layer_value(2, false)
...
func set_is_reverting(v: bool) -> void:
	...
	mount.set_collision_layer_value(1, false)
	mount.set_collision_layer_value(2, false)
	fixture.set_collision_layer_value(1, false)
	fixture.set_collision_layer_value(2, false)
