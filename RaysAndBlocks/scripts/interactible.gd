...
func _ready() -> void:
	...
	mount.set_collision_layer_value(Constants.CollisionLayer.PHYSICAL, true)
	...
	mount.set_collision_mask_value(Constants.CollisionLayer.PHYSICAL, true)
	...
	fixture.set_collision_layer_value(Constants.CollisionLayer.PHYSICAL, false)
	...
	fixture.set_collision_mask_value(Constants.CollisionLayer.PHYSICAL, false)
...
func set_is_reverting(v: bool) -> void:
	...
	mount.set_collision_layer_value(Constants.CollisionLayer.PHYSICAL, false)
	mount.set_collision_layer_value(Constants.CollisionLayer.LASERS, false)
	mount.set_collision_layer_value(Constants.CollisionLayer.REVERSE_CAST, false)
